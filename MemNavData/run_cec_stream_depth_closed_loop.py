...
MEM_PY = "/home/asus/miniconda3/envs/memnav/bin/python"
HAB_PY = "/home/asus/miniconda3/envs/habitat/bin/python"
MEM_CKPT = Path("/home/asus/Research/Nav-axis-uturn/.diagnostics/unseen_scene_eval_20260803/checkpoints/gatecurr600.memnav.ckpt")
NAV_CKPT = Path("/home/asus/Research/Nav/NavDP/baselines/navdp/checkpoints/navdp_checkpoint.ckpt")
...
def hab_env():
    env = os.environ.copy()
    vendor = "/home/asus/miniconda3/envs/habitat/lib/python3.9/site-packages/pip/_vendor"
    env.update(PYTHONPATH=f"{ROOT}:{ROOT}/MemNavData:{vendor}",
