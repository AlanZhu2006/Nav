#!/usr/bin/env bash
# Scene-OOF evaluation of the unified top-8 + REJECT learned relocalizer.
set -euo pipefail
umask 0022

readonly SOURCE_ROOT=/home/cv/memnav_eval/source_bundles/pi3x_set_relocalizer_v1_1_f5b5703833605b79
readonly SOURCE_RECEIPT=${SOURCE_ROOT}/SOURCE_BUNDLE.sha256
readonly EXPECTED_SOURCE_RECEIPT_SHA=f5b5703833605b7981662d72b0c8e88ec58752c13104cfaa8b4e2a59f4e75a6d
...
readonly TRAINER=${SOURCE_ROOT}/MemNavData/train_pi3x_set_relocalizer_oof.py
...
"${PYTHON}" -m pytest -q -p no:cacheprovider \
  ...
  "${SOURCE_ROOT}/MemNavData/test_train_pi3x_set_relocalizer_oof.py" \
