#!/usr/bin/env bash
# Submit the CPU causal-scale acceptance stage only from an exact clean commit.
...
printf 'submitted_causal_scale_acceptance_job=%s commit=%s launcher_sha256=%s\n' \
